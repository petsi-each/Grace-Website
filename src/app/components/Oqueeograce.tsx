...
export default function Oqueeograce() {
    ...
    return (
        <div className="my-16">
            ...
            <section className="bg-gradient-to-b from-vermelhoGrace to-[#feb581] py-2 md:py-4 px-8 md:px-16 lg:px-32 flex flex-col items-center"> {/*TODO: (bug) A onda superior está sendo reinderizada com um pequeno espaço à esquerda pelo Firefox*/} 
                {/*tamanho header não está sendo corretamente definido para os diferentes tamanhos de tela*/}
                <h1 className="mb-4 md:mb-8 lg:mb-12 font-Poppins font-bold text-brancoGrace text-xl md:text-2xl md:text-4xl">O que fazemos?</h1> 
                {/*tamanho da fonte não está sendo corretamente definido para os diferentes tamanhos de tela --> md e lg aparentam ser reenderizados da mesma forma*/}
                <p className="font-Poppins text-center text-brancoGrace text-xs md:text-base lg:text-lg">O GRACE é um projeto de extensão do curso de Sistemas de Informação (Escola de Artes, CIências e Humanidades) da Universidade de São Paulo. Nosso objetivo é <b>incentivar</b> e <b>manter</b> meninas na área da computação, a fim de diminuir a disparidade de gênero, por meio de atividades práticas e tecnológicas!</p>
