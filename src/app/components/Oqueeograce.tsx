...
export default function Oqueeograce() {
    ...
    return (
        <div className="my-16">
            ...
            <section className="bg-gradient-to-b from-vermelhoGrace to-[#feb581] py-4 px-12 md:px-16 lg:px-32 flex flex-col items-center"> {/*TODO: (bug) A onda superior está sendo reinderizada com um pequeno espaço à esquerda pelo Firefox*/} 
